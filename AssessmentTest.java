...
public class AssessmentTest {
	/*
	Welcome to V2 of Qa Assessment. You really dont want to see the first version.
	All tests pass however i did use stackover flow for help and some collagues.
	The code isnt clean or efficent at the moment but i would like to tidy it up at somepoint.
	There are also a few points that i still dont quite get as well.
	Enjoy
	Ryan Cawthorn
	 */
